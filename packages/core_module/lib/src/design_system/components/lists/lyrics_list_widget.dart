...
class _LyricsListWidgetState extends State<LyricsListWidget> {
  ...
  final ValueNotifier<int?> _tappedIndex = ValueNotifier(null);
          ...
          return ValueListenableBuilder<int?>(
            ...
            builder: (context, tappedIndex, child) {
              ...
              return AnimatedContainer(
                ...
                curve: Curves.easeIn,
                decoration: isTapped ? tappedDecoration : defaultDecoration,
                child: GestureDetector(
                  ...
                  child: InkWell(
                    onTap: () {
                      _store.lyricEntity = _store.entitiesList[index];
                      _tappedIndex.value = index;
                      Future.delayed(const Duration(milliseconds: 300), () {
                        widget.onTap?.call();
                        if (mounted) {
                          _tappedIndex.value = null;
                        }
                      });
                    },
                    child: itemContent,
