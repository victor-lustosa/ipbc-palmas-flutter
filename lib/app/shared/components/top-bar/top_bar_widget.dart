        ...
        builder: (context) {
          return Stack(
            ...
            children: [
              ...
              Align(
                alignment: MediaQuery.of(context).orientation.name == 'portrait' ? const Alignment(0.67,0.23): const Alignment(0.77,-0.2),
                child: Padding(
              ...
              Align(
                alignment: MediaQuery.of(context).orientation.name == 'portrait' ? const Alignment(0.98, 0.24): const Alignment(0.92,-0.2),
                child: Padding(
